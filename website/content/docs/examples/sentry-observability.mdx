---
title: "Example: Sentry Observability Setup"
description: "Quick start for implementing error tracking, performance monitoring, and distributed tracing with Sentry."
---
